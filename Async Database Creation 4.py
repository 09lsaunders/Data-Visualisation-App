...
dfemsnov18 = pd.read_csv('ems-nov-2018_for_upload.csv')
...
dfsynnov18 = pd.read_csv('synetica-nov-2018_for_upload.csv')
...
dfwifinov18 = pd.read_csv('wifi_2018-11_for_upload.csv')
...
EMStablesdf.to_csv("EMStables.csv")
Syntablesdf.to_csv("Syntables.csv")
Wifitablesnamesdf.to_csv("Wifitables.csv")
